...
#defining X and y
#ERROR HEAR
X = merged_sets.groupby(['selfies', 'selfies'], axis = 1, dropna = True)
y = merged_sets.drop(['smiles', 'standard_smiles', 'selfies', 'inchi', 'inchikey'], axis = 1)
print(X)
...
#feature selection
X_train = train_df['selfies']
y_train = train_df['APR_HepG2_CellCycleArrest_24h_dn']

X_val = val_df['selfies']
y_val = val_df['APR_HepG2_CellCycleArrest_24h_dn']

X_test = test_df['selfies']
y_test = test_df['APR_HepG2_CellCycleArrest_24h_dn']
...
df_selfies_train = X_train['selfies']
...
X_tox_tensor_train = torch.from_numpy(selfies_array_train)
y_tox_tensor_train = torch.from_numpy(y_train)
...
print(X_tox_tensor_train)
print(y_tox_tensor_train = torch.from_numpy(y_train))
